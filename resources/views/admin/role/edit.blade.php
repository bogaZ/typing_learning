...
<div class="m-4">
    <div class="p-0 d-flex justify-content-center">
        <div class="p-5 card bg-white shadow col-md-5">
            <form action="{{route('role.store', $role->id)}}" method="post">
                @csrf
                @method('PATCH')
                <label for="characterinput">Nama Role</label>
                <input type="text" name="name" id="characterinput" class="form-control mb-3" value="{{$role->name}}">
